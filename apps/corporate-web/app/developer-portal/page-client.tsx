...

{
  ...
  "create-transaction": {
    ...
    fields: [
      ...
      ["metadata", "No", "Optional key-value object containing arbitrary metadata properties."]
    ],
...
x-api-key: bank-alpha-dev-key`,
  ...
  "create-bulk-transaction": {
    ...
    fields: [
      ...
      ["payments", "Yes", "Array of payout items, each containing beneficiaryId, amount (in paise), transactionReference, and optional metadata object."]
    ],
