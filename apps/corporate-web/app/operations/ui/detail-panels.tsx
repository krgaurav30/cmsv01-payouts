  ...
  return (
    <>
      ...
      <div className="ops-fields two">
        ...
        {transaction.utr && (
          <div className="ops-static-field">
            <span className="ops-context-label">UTR</span>
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              <strong>{transaction.utr}</strong>
              <button
                type="button"
                onClick={() => handleCopy("utr", transaction.utr!)}
                style={{
                  background: "none",
                  border: "none",
                  cursor: "pointer",
                  padding: "2px",
                  color: copiedId === "utr" ? "var(--success)" : "var(--text-tertiary)",
                  display: "inline-flex",
                  alignItems: "center"
                }}
                title="Copy UTR"
        ...
        {transaction.narration && (
          <div className="ops-static-field">
            <span className="ops-context-label">Narration</span>
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              <strong>{transaction.narration}</strong>
              <button
                type="button"
                onClick={() => handleCopy("narration", transaction.narration!)}
                style={{
                  background: "none",
                  border: "none",
                  cursor: "pointer",
                  padding: "2px",
                  color: copiedId === "narration" ? "var(--success)" : "var(--text-tertiary)",
                  display: "inline-flex",
                  alignItems: "center"
                }}
